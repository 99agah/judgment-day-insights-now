...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center islamic-pattern p-4 animate-page-transition">
      <Card className="max-w-lg w-full mx-auto islamic-card relative overflow-hidden">
        ...
        <CardContent className="pt-8 pb-6">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-2 text-islamic-green">Signs of the Day of Judgment</h1>
            <p className="arabic-text text-xl mb-4 text-islamic-dark-blue">علامات يوم القيامة</p>
            <p className="text-sm text-muted-foreground mb-6">
              Explore, discuss, and track the signs foretold by Islamic tradition that precede the Day of Judgment.
            </p>
            
            <div className="quran-text text-center my-6 text-lg px-4 py-3 bg-muted rounded-lg">
      ...
      <div className="mt-8 text-center max-w-md">
        ...
        <Card className="p-4 islamic-card">
